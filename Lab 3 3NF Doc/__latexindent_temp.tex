...
\begin{description}
    ...
    \item $\{A\}^+$=\{ABCDEFG\},\quad $\{B\}^+$=\{ACDEFG\},\quad $\{C\}^+$=\{BADEFG\}, \\ \ $\{G\}^+$=\{EF\}
    \item 
    \item we remove \quad A$\rightarrow$E,\ A$\rightarrow$F \quad\quad\quad\quad\quad\quad\quad\quad\quad\quad $\{A\}^+$=\{ABCDEFG\}
    \item
    \item we remove  \quad B$\rightarrow$C,\ B$\rightarrow$D,\ B$\rightarrow$E,\ B$\rightarrow$F,\ B$\rightarrow$G \quad $\{B\}^+$=\{ACDEFG\}
    \item
    \item we remove \quad \ C$\rightarrow$B,\ C$\rightarrow$D,\ C$\rightarrow$E,\ C$\rightarrow$F,\ C$\rightarrow$G \quad $\{C\}^+$=\{BADEFG\}
    
    \item\item   CUSTOMER =\{
        A$\rightarrow$B,\quad A$\rightarrow$C,\quad A$\rightarrow$D,\quad A$\rightarrow$G
        \quad G$\rightarrow$E,\quad G$\rightarrow$F\}
    ...
    \item[]  CUSTOMER=\{A$\rightarrow$BCDG, \quad G$\rightarrow$EF \}
    ...
    \item\item[Step 4:]
    \item[]  Final Answer: 
    \item $R_1$ (customer\_id, username, email,password,phone\_num)
    \item $R_2$ (phone\_num,full\_name,address)
    \item $\therefore$ The relation is in 3NF 
    \end{description}
